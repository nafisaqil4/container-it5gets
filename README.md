...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-it5gets.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-it5gets.containers.anotherwebservice.com/
...
```
git clone git@github.com:nafisaqil4/container-it5gets.git
cd container-it5gets
```
...
```
docker attach container-it5gets
```
